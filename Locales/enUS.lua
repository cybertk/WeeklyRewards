...
L["settings_show_tracking_column"] = "Show tracking column"
...
L["candidate_from_quest_format"] = "Rewards from {quest:%s}"
L["candidate_one_of_following_quests"] = "Which can be one of the following quests"
