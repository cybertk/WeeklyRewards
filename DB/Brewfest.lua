...
namespace.DB.rewardCandidiates["brewfest"] = {
	{
		...
		description = "Brewfest One-time Mainline Quests",
		minimumLevel = 1,
	...
	},
	{
		...
		key = "Brew:Daily",
		group = RewardsGroup.BREWFEST_EVENT,
		description = "Brewfest Daily Quests",
		minimumLevel = 10,
	...
	},
	{
		...
		key = "BarTab:QT",
		group = RewardsGroup.BREWFEST_EVENT,
		description = "Donate to taverns across the Quel'Thalas to cover the tab!",
		minimumLevel = 1,
		timeLeft = "end-of-event",
		unlockEvent = 372,
		pick = 8,
		entries = {
			{ quest = 96910, name = "{quest:84305}: {map:2393}" },
			{ quest = 96911, name = "{quest:84305}: {map:2395}" },
			{ quest = 96922, name = "{quest:84305}: {map:2437} ({area:16184})" },
			{ quest = 96923, name = "{quest:84305}: {map:2437} ({area:16186})" },
			{ quest = 96924, name = "{quest:84305}: {map:2413} ({area:15918})" },
			{ quest = 96925, name = "{quest:84305}: {map:2413} ({area:15921})" },
			{ quest = 96926, name = "{quest:84305}: {map:2405}" },
			{ quest = 96952, name = "{quest:84305}: {map:2541}" },
		},
	},
}
